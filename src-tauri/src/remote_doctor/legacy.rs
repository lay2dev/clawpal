...
mod tests {
    ...
    use crate::remote_doctor::agent::detect_method_name;
    use crate::remote_doctor::config::load_gateway_config as remote_doctor_gateway_config;
    use crate::remote_doctor::plan::request_plan;
    ...
    use crate::remote_doctor::types::PlanCommand;
