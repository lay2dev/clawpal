...
use crate::commands::{
    ...
    get_status_light, get_system_status, get_watchdog_status, get_zeroclaw_usage_stats,
    list_agents_overview, list_backups,
    ...
    remote_start_watchdog, remote_stop_watchdog, remote_test_model_profile,
