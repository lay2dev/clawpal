...
use crate::commands::{
    ...
    diagnose_primary_via_rescue, diagnose_ssh, discover_local_instances,
    exchange_remote_doctor_invite_code, ensure_access_profile,
    ...
    set_bug_report_settings, set_global_model, set_remote_doctor_gateway_auth_token_preference,
    set_remote_doctor_gateway_url_preference, set_session_model_override,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            set_global_model,
            set_agent_model,
            exchange_remote_doctor_invite_code,
            ...
            remote_backup_before_upgrade_stream,
            remote_list_backups,
