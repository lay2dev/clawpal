...
use crate::commands::{
    ...
    list_discord_guild_channels, list_discord_guild_channels_fast, list_history,
    ...
    run_openclaw_upgrade, save_recipe_workspace_source, set_active_clawpal_data_dir,
    ...
    stop_watchdog, test_model_profile, trigger_cron_job, uninstall_watchdog,
    upgrade_bundled_recipe_workspace_source, upsert_model_profile, upsert_ssh_host,
